...
<Steps>
  ...
  <Step title="Click Connect with Stripe">
    ...
    <Frame caption="Connect with Stripe button on the Billing page">
      <img src="/images/doctors/stripe-connect-button.png" alt="Connect with Stripe button on the Billing page" />
    </Frame>
  </Step>
  <Step title="Complete Stripe onboarding">
    ...
    <Frame caption="Stripe Connect onboarding flow">
      <img src="/images/doctors/stripe-onboarding.png" alt="Stripe Connect onboarding flow" />
    </Frame>
  </Step>
