...
<Frame caption="Create Invoice form with service selection">
  <img src="/images/doctors/create-invoice-form.png" alt="Create Invoice form with service selection" />
</Frame>
...
<Frame caption="Invoice line items with quantity, rate, and amount">
  <img src="/images/doctors/invoice-line-items.png" alt="Invoice line items with quantity, rate, and amount" />
</Frame>
...
<Frame caption="Invoice list showing different statuses">
  <img src="/images/doctors/invoice-statuses.png" alt="Invoice list showing different statuses" />
</Frame>
...
<Frame caption="Invoice PDF displayed inline in the browser">
  <img src="/images/doctors/invoice-pdf-preview.png" alt="Invoice PDF displayed inline in the browser" />
</Frame>
