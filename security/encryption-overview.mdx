...
<Frame caption="End-to-end encryption architecture — passphrase to per-case key flow">
  <img src="/images/security/encryption-architecture.png" alt="End-to-end encryption architecture — passphrase to per-case key flow" />
</Frame>
...
<Frame caption="How encryption keys are shared between team members">
  <img src="/images/security/key-sharing-diagram.png" alt="How encryption keys are shared between team members" />
</Frame>
